        ...
        <Container fluid className="containerBody">
            ...
            <Row className="mt-4 mb-3">
                ...
                <Col md="7" className="text-start">
                    ...
                    <p>
                        <strong>Tropp Fun Radio</strong> è nata nella Città di Sarno, a seguito del concorso LIBERA LA TUA CREATIVITÀ’ tenutosi Giovedì 14 luglio 2022 presso i giardini di Villa Lanzara. 
                        Nasce come  Radio interscolastica che offre corsi  di radio  gratuiti ai ragazzi  del territorio (conduzione, regia, djing,  ecc.) e raccoglie da  subito il pieno consenso delle Scuole locali  e di tanti amici imprenditori che hanno deciso di sostenere e di far crescere l’iniziativa. In seguito grazie alla fusione con l’emittente <strong>RRC</strong>, acquisisce la possibilità tramite concessione ministeriale di trasmettere anche in DAB+ (Digital Audio Broadcasting) in tutta la regione Campania.<br/>

        ...
        <Container fluid className="mt-5 containerBody">
            <Row>
                <Col sm="12" style={{padding: "0px"}}>
                    <div className="boxShadow">
                        <h2 className="p-2 bg-secondary text-white">Chat Room</h2>
            ...
            <Row>
                <Col md="4" style={{padding: "0px"}}>
                    <div className="boxShadow">
                        <h2 className="p-2 bg-secondary text-white">I volti di RRC</h2>
                ...
                <Col md="8">
                    <div className="boxShadow" style={{padding: "0px"}}>
                        <h2 className="p-2 bg-secondary text-white">Oggi in onda</h2>
                        <PalinsestoToday/>
                    </div>
                </Col>
            </Row>
